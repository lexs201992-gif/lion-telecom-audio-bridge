...
<unipnp version="0">
        ...
        <policy>
            <item id="activity_start">
                <action name="POWER_BOOST">
                    <string>*,POWER_HINT_VENDOR_INTERACTION_LAUNCH,500</string>
                    ...
                    <string>com.android.chrome,POWER_HINT_VENDOR_INTERACTION_LAUNCH,3000</string>
                    <string>fr.thema.wear.watch.feisar,POWER_HINT_VENDOR_INTERACTION_LAUNCH,3000</string>
                    <string>com.engro.cleanerforsns,POWER_HINT_VENDOR_INTERACTION_LAUNCH,3000</string>
                    <string>com.amazon.mShop.android.shopping,POWER_HINT_VENDOR_INTERACTION_LAUNCH,3000</string>
                    <string>com.viber.voip,POWER_HINT_VENDOR_INTERACTION_LAUNCH,3000</string>
                    <string>com.facebook.orca,POWER_HINT_VENDOR_INTERACTION_LAUNCH,3000</string>
                    <string>com.google.android.dialer,POWER_HINT_VENDOR_INTERACTION_LAUNCH,3000</string>
                    <string>com.netflix.mediaclient,POWER_HINT_VENDOR_INTERACTION_LAUNCH,3500</string>
                </action>
                <action name="FAST_KILL">
                    <string>com.motorola.odm.camera3,260</string>
                </action>
        ...
        <policy>
            <item id="activity_resumed">
                <action name="POWER_BOOST">
                    ...
                    <string>o.cleanerforsns,POWER_HINT_VENDOR_INTERACTION_LAUNCH,6000</string>
                    <string>com.instagram.android,POWER_HINT_VENDOR_INTERACTION_LAUNCH,0</string>
                    <string>myradio.radio.fmradio.liveradio.radiostation,POWER_HINT_VENDOR_INTERACTION_LAUNCH,0</string>
                    <string>com.google.android.dialer,POWER_HINT_VENDOR_INTERACTION_LAUNCH,0</string>
                    <string>com.netflix.mediaclient,POWER_HINT_VENDOR_INTERACTION_LAUNCH,0</string>
                </action>
                <action name="PROCESS_SCHED">
                    ...
                    <string>com.tencent.ig|com.tencent.ig|MainThread-UE4, other, -19#RenderThread*, other, -19|-1</string>
                    <string>com.tencent.igce|com.tencent.igce|MainThread-UE4, other, -19#RenderThread*, other, -19|-1</string>
                    <string>com.motorola.launcher3|com.motorola.launcher3|orola.launcher3, other, -19#RenderThread*, other, -19|-1</string>
                    <string>com.google.android.youtube|com.google.android.youtube|UI Thread,rr,1#RenderThread*,other,-19#BG Thread*,other,-19|-1</string>
                    <string>com.google.android.apps.youtube.music|com.google.android.apps.youtube.music|UI Thread,rr,1#RenderThread*,other,-19#BG Thread*,other,-19|-1</string>
                    <string>com.google.android.apps.photos|com.google.android.apps.photos|UI Thread,rr,1#RenderThread*,other,-19#BG Thread*,other,-19|-1</string>
                </action>
            </item>
        ...
        <policy>
            <item id="move">
                <action name="POWER_BOOST">
                    ...
                    <string>com.motorola.launcher3,POWER_HINT_VENDOR_INTERACTION_TOUCH,400</string>
                </action>
            </item>
        ...
        <policy>
            <item id="move">
                <action name="POWER_BOOST">
                    ...
                    <string>com.google.android.apps.photos/com.google.android.apps.photos.pager.HostPhotoPagerActivity,5,POWER_HINT_VENDOR_INTERACTION_TOUCH,0</string>
                </action>
            </item>
            <item id="fling">
                <action name="POWER_BOOST">
    ...
    <!-- The feature AppLmkdKillerScene with id 8 has been deleted.
    Please see Bug/2073976 and Bug/2111658 for more details. -->
    ...
    <feature name="KeepAppAliveScene">
        ...
        <policy>
            <item id="keep_app_alive_list">
                ...
                <string>com.motorola.odm.camera3</string>
            </item>
        </policy>
    </feature>
    ...
    <feature name="SnapShotFeature">
        ...
        <policy>
            <item id="white_list">
                ...
                <string>fr.thema.wear.watch.feisar</string>
                <string>com.engro.cleanerforsns</string>
                <string>com.amazon.mShop.android.shopping</string>
                <string>com.viber.voip</string>
    ...
    <feature name="AppAnimFeature">
        ...
        <policy>
            <item name="config_anim_app_start">
                <string>*,1,70,1</string>
                <string>com.android.camera2,0,-1,-1</string>
                <string>com.whatsapp,1,30,1</string>
                <string>fr.thema.wear.watch.feisar,0,-1,-1</string>
                <string>com.engro.cleanerforsns,0,-1,-1</string>
